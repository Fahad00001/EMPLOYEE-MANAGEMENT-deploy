...
function AddEmployee({ showmodal,setShowModal,fetchEmployees }) {
            ...
            <div className="modal-body">
                <form onSubmit={(e)=>handlesubmit(e)}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control " name="salary" value={employee.salary} onChange={handleChange} required/>
                    </div>
                    <div className="mb-3">
                        <label className="form-label">profile Image</label>
                        <input type="file" className="form-control " name="profileImage" onChange={handleFileChange} required/>
                    </div>
